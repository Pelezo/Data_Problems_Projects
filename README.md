...
**Approach:** The approach in this repository formulates the problem as classification task , using decision tree and XGBoost as the model with the full time series of features as input. I compared the performance of the 2 different  models. 
